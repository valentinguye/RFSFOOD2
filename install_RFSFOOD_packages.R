...
# This project's data processing reproducibility is based on package version tracking enabled by the package {renv}. 
...
# renv/library is not provided with the project, but created the first time R is launched from this project
# within the Rstudio project  
